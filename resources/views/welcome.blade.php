...
<body>
    <div id="contenedor_notificaciones"
        style="width: 300px; height:auto; margin:0; top:200px; right:0; position: absolute;">
            ...
            <div class="container topnav">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                aria-expanded="false" onclick="AgregarNuevoTab('{{url ('crm')}}','CRMs')">
                        ...
                        {{-- CLIENTES --}}
                        @foreach(Auth::user()->perfil->componentes as $componente)
                        @if($componente->nombre == "crear cliente" || $componente->nombre == "indice clientes" ||
                        $componente->nombre == "indice solicitantes")
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                aria-expanded="false"><i class="fa fa-user"></i> Clientes<span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu" role="menu">
                                @foreach(Auth::user()->perfil->componentes as $c)
                                ...
                                <li>
                                    <a href="#"
                                        onclick="AgregarNuevoTab('{{ url('/clientes/create')}}','Agrega Cliente')">
                        ...
                        {{-- RECURSOS HUMANOS --}}
                        @foreach(Auth::user()->perfil->componentes as $componente)
                        @if($componente->nombre == "indice empleados" || $componente->nombre == "crear empleado" ||
                        $componente->nombre == "indice grupos" || $componente->nombre == "crear grupo")
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li>
                                    <a tabindex="-1" href="#"
                                        onclick="AgregarNuevoTab('{{ url('empleados/create') }}','Alta Empleado')">
                                        <i class="fa fa-plus"></i> Alta
                                    </a>
                                </li>
                                @endif
                                ...
                                <li>
                                    <a href="#"
                                        onclick="AgregarNuevoTab('{{ route('vendedor.asignar') }}','Asignar Vendedor')">
                                ...
                                @endif
                                @endforeach
                                @if(Auth::user()->id == 1 || Auth::user()->perfil->componentes()->where('nombre','indice
                                empleados')->first())
                                <li>
                                    <a href="#"
                                        onclick="AgregarNuevoTab('{{ url('empleados/eliminados') }}','Empleados eliminados')">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li>
                                    <a tabindex="-1" href="#"
                                        onclick="AgregarNuevoTab('{{ url('control_vendedores')}}','Control Vendedores')">
                        ...
                        {{-- PROVEEDORES --}}
                        @foreach(Auth::user()->perfil->componentes as $componente)
                        @if($componente->nombre == "indice proveedores" || $componente->nombre == "crear proveedor" ||
                        $componente->nombre == "alta excel" || $componente->nombre == "indice productos")
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="#"
                                                onclick="AgregarNuevoTab('{{ url('import-export-csv-excel') }}','Importar Excel')">
                                        ...
                                        <li>
                                            <a href="#"
                                                onclick="AgregarNuevoTab('{{ url('provedores-agregar-tipo') }}','Agregar tipo')">
                                        ...
                                        <li>
                                            <a href="#"
                                                onclick="AgregarNuevoTab('{{ url('provedores-agregar-categoria') }}','Agregar categoria')">
                        ...
                        {{-- OFICINAS --}}
                        @foreach(Auth::user()->perfil->componentes as $componente)
                        @if($componente->nombre == "indice estados" || $componente->nombre == "indice oficinas" ||
                        $componente->nombre == "indice puntos")
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li>
                                    <a style="display: none;" href="#"
                                        onclick="AgregarNuevoTab('{{ url('region')}}','Región')">
                                ...
                                <li>
                                    <a style="display: none;" href="#"
                                        onclick="AgregarNuevoTab('{{ url('estado') }}','Estado')">
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="#"
                                                onclick="AgregarNuevoTab('{{ url('/grupos/create')}}','Crear Grupo')">
                                                <i class="fa fa-plus"></i> Alta
                                            </a>
                                        </li>
                                        @endif
                                        ...
                                        <li>
                                            <a href="#"
                                                onclick="AgregarNuevoTab('{{ url('/grupos')}}','Buscar Grupos')">
                                                <i class="fa fa-search"></i> Búsqueda
                                            </a>
                                        </li>
                                        @endif
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li>
                                    <a href="#"
                                        onclick="AgregarNuevoTab('{{ route('precargas.carros.index') }}','Carros')">
                                        <i class="fa fa-car"></i> Carros
                                    </a>
                                </li>
                                <li>
                                    <a href="#"
                                        onclick="AgregarNuevoTab('{{ route('precargas.motos.index') }}','Motos')">
                                        <i class="fa fa-motorcycle"></i> Motos
                                    </a>
                                </li>
                                <li>
                                    <a href="#"
                                        onclick="AgregarNuevoTab('{{ route('precargas.mensualidades.index') }}','Mensualidades')">
                                        <i class="fa fa-calendar"></i> Mensualidades
                                    </a>
                                </li>
                                <li>
                                    <a href="#"
                                        onclick="AgregarNuevoTab('{{ route('precargas.aperturas.index') }}','Apertura')">
                                        <i class="fa fa-folder-open"></i> Apertura
                                    </a>
                                </li>
                            </ul>
                        </li>
